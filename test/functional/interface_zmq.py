...
from test_framework.messages import neonxhash, hash256
...
def neonxhash_reversed(byte_str):
    return neonxhash(byte_str)[::-1]
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], neonxhash_reversed(block[:80]).hex())
