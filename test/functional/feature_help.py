...
"""Verify that starting neonxd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start neonxd with -h for help text")
        ...
        self.log.info("Start neonxd with -version for version information")
        ...
        self.log.info("Start neonxdd with -fakearg to make sure it does not start")
