...
Arguments:
    <base_directory> - The base directory of a NeonX Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The NeonX Core developers'
...
Arguments:
    <base_directory> - The base directory of NeonX Core source code repository.
"""
...
Arguments:
    <file> - A source file in the NeonX Core repository.
"""
