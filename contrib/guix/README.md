# Bootstrappable NeonX Core Builds

This directory contains the files necessary to perform bootstrappable NeonX
Core builds.
...
To build NeonX Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      NeonX Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/neonx-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/neonxpay/guix.sigs).
...
[guix-docker]: https://github.com/NeonXGit/tree/master/contrib/guix/Dockerfile
