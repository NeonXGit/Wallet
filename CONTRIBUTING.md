Contributing to NeonX Core
============================

The NeonX Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/NeonXGit/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
[Translation Process](https://github.com/NeonXGit/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NeonX Core project (and related
projects such as libsecp256k1), and is not to be confused with overall NeonX
Network Protocol consensus changes.

Whether a pull request is merged into NeonX Core rests with the project merge
...
Patches that change NeonX consensus rules are considerably more involved than
...
Where a patch set proposes to change the NeonX consensus, it must have been
...
The review process is normally fairly responsive on the NeonX Core repository, however
...
Bitcoin Backports are an incredibly valuable part of NeonX's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for NeonX](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each NeonX Core release.
