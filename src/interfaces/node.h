...
//! Interface for the src/evo part of a neonx node (neonxd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a neonx node (neonxd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a neonx node (neonxd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a neonx node (neonxd process).
...
//! Top-level interface for a neonx node (neonxd process).
class Node
{
public:
    virtual ~Node() {}
