 ...
 *  We have 4 times smaller block times in NeonX, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        NeonX Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // NEO this code also handles non-TXs (NeonX specific messages)
