...
/** Utility functions used by the NeonX Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "neonx:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load neonx specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a neonx specific theme is activated (light/dark).*/
