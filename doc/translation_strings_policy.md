...
This document provides guidelines for internationalization of the NeonX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `neonx_en.ts` remains unchanged.
