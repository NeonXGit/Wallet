# Support for Output Descriptors in NeonX Core

Since NeonX Core v0.17, there is support for Output Descriptors. This is a
...
existing NeonX Core wallets, a convenience function `combo` is
...
All RPCs in NeonX Core will include the checksum in their output. Only
