...
This mechanism has been integrated into Bitcore-Node-NeonX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/neonxpay/insight-api-neonx#web-socket-api](https://github.com/neonxpay/insight-api-neonx#web-socket-api)
* API: [https://github.com/neonxpay/insight-api-neonx#instantsend-transactions](https://github.com/neonxpay/insight-api-neonx#instantsend-transactions)
