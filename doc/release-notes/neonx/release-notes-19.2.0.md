...
At the first startup NeonX Core will run a migration process which can take
...
incompatible with older versions of NeonX Core, so a db migration path was
...
See detailed [set of changes](https://github.com/NeonXGit/compare/v19.1.0...neonxpay:v19.2.0).
