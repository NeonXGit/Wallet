...
- [`f7b71f660`](https://github.com/NeonXGit/commit/f7b71f660) Merge #13611: [bugfix] Use `__cpuid_count` for gnu C to avoid gitian build fail.
...
- [`c35aa663b`](https://github.com/NeonXGit/commit/c35aa663b) Merge #11326: Fix crash on shutdown with invalid wallet
...
- [`76776fb62`](https://github.com/NeonXGit/commit/76776fb62) Merge #11017: [wallet] Close DB on error.
...
- [`1adc2001a`](https://github.com/NeonXGit/commit/1adc2001a) Merge #10798: [tests] [utils] test bitcoin-cli
...
- [`05ad6d2ec`](https://github.com/NeonXGit/commit/05ad6d2ec) change nEnd to index (might break the progress bar on wallet creation, should test)
...
- [`f2dcac3a4`](https://github.com/NeonXGit/commit/f2dcac3a4) Merge #10757: RPC: Introduce getblockstats to plot things (#3058)
...
- [`5f2aef826`](https://github.com/NeonXGit/commit/5f2aef826) Merge #11003: Docs: Capitalize bullet points in CONTRIBUTING guide
...
- [`80bc6df26`](https://github.com/NeonXGit/commit/80bc6df26) Merge #10892: Replace traditional for with ranged for in block and transaction primitives
...
- [`644274fde`](https://github.com/NeonXGit/commit/644274fde) Merge #9980: Fix mem access violation merkleblock
...
- [`cf40b5409`](https://github.com/NeonXGit/commit/cf40b5409) Merge #10676: document script-based return fields for validateaddress
...
- [`3f4d08d36`](https://github.com/NeonXGit/commit/3f4d08d36) Merge #10565: [coverage] Remove subtrees and benchmarks from coverage report
...
- [`10716ea6d`](https://github.com/NeonXGit/commit/10716ea6d) Merge #10575: Header include guideline
...
- [`6ad8fe0e9`](https://github.com/NeonXGit/commit/6ad8fe0e9) adjust CoinType logic
...
- [`fbae76b21`](https://github.com/NeonXGit/commit/fbae76b21) Merge #10011: build: Fix typo s/HAVE_DONTWAIT/HAVE_MSG_DONTWAIT
...
- [`d03bc6d02`](https://github.com/NeonXGit/commit/d03bc6d02) No need to send so many headers to node0
...
- [`3d87faff5`](https://github.com/NeonXGit/commit/3d87faff5) Merge #10307: [tests] allow zmq test to be run in out-of-tree builds
...
- [`db2f8cb13`](https://github.com/NeonXGit/commit/db2f8cb13) Merge #10225: [test] Add aborttrescan tests
...
- [`d4e75abbf`](https://github.com/NeonXGit/commit/d4e75abbf) Call new signals in CChainLocksHandler
...
- [`05cb5a058`](https://github.com/NeonXGit/commit/05cb5a058) Merge #10108: ApproximateBestSubset should take inputs by reference, not value
...
- [`2aa3f890d`](https://github.com/NeonXGit/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/NeonXGit/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/NeonXGit/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/NeonXGit/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/NeonXGit/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/NeonXGit/commit/67c735b15) s/bitcoin-config.h/neonx-config.h/
- [`2f63322cd`](https://github.com/NeonXGit/commit/2f63322cd) neonxify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/NeonXGit/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/NeonXGit/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/NeonXGit/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/NeonXGit/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/NeonXGit/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/NeonXGit/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/NeonXGit/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/NeonXGit/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/NeonXGit/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/NeonXGit/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/NeonXGit/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/NeonXGit/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/NeonXGit/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/NeonXGit/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/NeonXGit/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/NeonXGit/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/NeonXGit/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/NeonXGit/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/NeonXGit/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/NeonXGit/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/NeonXGit/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/NeonXGit/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/NeonXGit/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/NeonXGit/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/NeonXGit/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/NeonXGit/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/NeonXGit/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/NeonXGit/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/NeonXGit/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/NeonXGit/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/NeonXGit/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/NeonXGit/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/NeonXGit/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/NeonXGit/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/NeonXGit/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/NeonXGit/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/NeonXGit/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/NeonXGit/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/NeonXGit/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/NeonXGit/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/NeonXGit/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/NeonXGit/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/NeonXGit/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/NeonXGit/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/NeonXGit/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/NeonXGit/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/NeonXGit/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/NeonXGit/commit/1cfda206a) Merge #9993: Initialize nRelockTime
