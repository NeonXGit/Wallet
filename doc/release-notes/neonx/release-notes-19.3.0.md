...
- `wipetxes`: New command for `neonx-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/NeonXGit/compare/v19.2.0...neonxpay:v19.3.0).
